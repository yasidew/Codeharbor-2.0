...
patterns = [
    {
        ...
        "complexity": "Advanced",
        "language": "Java",
        "context": "Cluster-wide singleton initialization in a distributed system",
        "edge_cases": ["Concurrency issues in distributed systems", "Cluster lock contention"],
        "dependencies": ["java.util.concurrent.locks.ReentrantLock"],
        "performance_notes": "Ensures cluster-wide synchronization with minimal overhead",
        "real_world_usage": "Distributed caching or configuration management systems",
        "testing_notes": "Simulate concurrent access to test lock performance",
        "comments": "This pattern is ideal for distributed systems with shared resources",
        "source": "Inspired by real-world distributed systems"
    },
    {
        "type": "FactoryMethod",
        "input_template": "public abstract class {name}Factory {{\n\n    public abstract Product createProduct();\n\n}}",
        "output_template": "public abstract class {name}Factory {{\n    public abstract Product createProduct();\n}}\n\npublic class Concrete{name}Factory extends {name}Factory {{\n    @Override\n    public Product createProduct() {{\n        return new ConcreteProduct();\n    }}\n}}\n\nclass ConcreteProduct implements Product {{\n    @Override\n    public void use() {{\n        System.out.println(\"Using the concrete product created by Factory Method\");\n    }}\n}}",
        "complexity": "Intermediate",
        "language": "Java",
        "context": "Dynamic object creation based on runtime requirements",
        "edge_cases": ["Invalid product requests", "Extensibility for new product types"],
        "dependencies": ["None"],
        "performance_notes": "Enables loose coupling between object creation and usage",
        "real_world_usage": "GUI frameworks or database connection pools",
        "testing_notes": "Test with mock dependencies for product creation",
        "comments": "This implementation follows the Open-Closed Principle",
        "source": "Inspired by GUI and database management systems"
    },
    {
        "type": "FactoryMethod",
        "input_template": "public class {name} {{\n\n    public {name}() {{}}\n\n}}",
...
dataset_filename = "augmented_factory_method_data.json"
